...
class Player {
    ...
    update(input, deltaTime, enemies){
        ...
        enemies.forEach(enemy => {
            ...
            const dy = (enemy.y + enemy.height/2) - (this.y + this.height/2) + 40;
...
function displayStatusText(context){
    ...
    if (gameOver){
        ...
        context.fillStyle = 'black';
        context.fillText("GAME OVER, press Enter or swipe down to restart!", canvas.width/4, 200);
        context.fillStyle = 'white';
        context.fillText("GAME OVER, press Enter or swipe down to restart!", canvas.width/4 + 2, 202);
    }
}
...
function animate(timeStamp){
    ...
    if (gameOver) displayStatusText(ctx);
}
animate(0);
